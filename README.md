...
16. Пример работы основной функции main():
Программа задает пользователю вопросы, и, в зависимости от полученных ответов,
формирует необходимые данные:

```
рограмма: Привет! Добро пожаловать в программу работы 
