...
@pytest.mark.parametrize( "value, string_search, expected", [
                          ([{"amount": "79931.03", "currency": "RUB", "description": "Открытие вклада"},
                            {"amount": "31957.58", "code": "RUB", "description": "Перевод организации"}], "организации", [{"amount": "31957.58", "code": "RUB", "description": "Перевод организации"}]),
    ([{"amount": "31957.58", "code": "RUB","description": "Перевод организации"},
      {"amount": "8221.37", "code": "USD", "description": "Перевод со счета на счет"}], "на счет", [{"amount": "8221.37", "code": "USD", "description": "Перевод со счета на счет"}]),
    ([{"amount": "31957.58", "code": "RUB","description": "Перевод организации"},
      {"amount": "8221.37", "code": "USD", "description": "Перевод со счета на счет"}], "вклада", "Не найдено ни одной транзакции, подходящей под ваши условия фильтрации"),
